...
class LessonSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = Lesson
		fields = ('lesson_title', 'lesson_detail', 'lesson_img', 'course')
...
class TopicSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = Topic
		fields = ('topic_title','topic_detail','topic_status', 'lesson')
	# def create(self, validated_data):
...
class SubtopicSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = Subtopic
		fields = ('subtopic_title', 'subtopic_detail','subtopic_image_link', 'topic')
