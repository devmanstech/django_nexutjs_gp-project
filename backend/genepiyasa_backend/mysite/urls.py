...
from userdetail import views as userprofile_views
from allauth.socialaccount.providers.facebook.views import FacebookOAuth2Adapter
from allauth.socialaccount.providers.google.views import GoogleOAuth2Adapter
from rest_auth.registration.views import SocialLoginView
from core.views import email_confirm_view
...
router.register(r'courses', courses_views.SubtopicView, 'courses')
router.register(r'users', courses_views.UserView, 'users')
router.register(r'answers', exams_views.Answer1View, 'answers')
